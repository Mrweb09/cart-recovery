                  ...
                  <div>
                    ...
                    {step === 'generating' && (
                      <div className="mt-2 text-gold">
                        ✦ Claude AI (claude-haiku-4-5): {generatingText}<span className="typing-cursor" />
                      </div>
                    )}
                    {(step === 'preview' || step === 'sent') && (
                      <div className="mt-2">
                        <div className="text-emerald-400">✓ Email generated by Claude AI</div>
          ...
          <div className="glass-card overflow-hidden flex flex-col">
            <div className="px-5 py-4 border-b border-white/5 flex items-center justify-between">
              <div className="text-sm font-medium text-white">
                ...
                {step === 'generating' && <span className="text-gold">Claude AI is writing...</span>}
                {(step === 'preview' || step === 'sent') && (
                ...
                <div className="flex flex-col items-center justify-center h-full p-8 min-h-[400px]">
                  ...
                  <div className="text-text-secondary text-sm text-center">
                    {step === 'webhook' ? 'Processing Shopify webhook...' : (
                      <div>
                        <div className="text-gold font-medium mb-2">Claude AI is writing...</div>
